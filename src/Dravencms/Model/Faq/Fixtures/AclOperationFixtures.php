...
class AclOperationFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        $operations = [
            'faq' => [
                'edit' => 'Umožnuje editaci FAQ',
                'delete' => 'Umožnuje smazání FAQ'
            ]
        ];
    ...
    {
        return ['Dravencms\Model\Faq\Fixtures\AclResourceFixtures', 'Dravencms\Model\User\Fixtures\GroupFixtures'];
    }
}